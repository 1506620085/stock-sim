                  ...
                  <div className="calculator-input-grid t-input-grid t-input-grid--base">
                    ...
                    <div className="calculator-asset-type-field">
                      <FieldLabelWithTip
                        ...
                        tip="成本类型决定费率规则：股票卖出计印花税，ETF 不计；佣金等按该类型的默认费率模板计算。"
                        tipAriaLabel="成本类型说明"
                      >
                        成本类型
                      </FieldLabelWithTip>
      ...
      <div className="calculator-form">
        ...
        <ResultTable
          rows={[
            ...
            ["目标上涨价格", targetRate == null ? "—" : currency(result.targetUpPrice)],
            ["目标下跌价格", targetRate == null ? "—" : currency(result.targetDownPrice)],
